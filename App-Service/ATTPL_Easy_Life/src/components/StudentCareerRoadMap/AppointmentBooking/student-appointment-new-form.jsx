...
import {createInstitutionAppointment} from '../../../redux/slices/CRM/StudentCareerRoad/IntitutionAppointmentSlice';
...
export default function StudentAppointmentNewForm({
  currAppointDetails,
  institutionOwnerId,
  navigation,
}) {
  ...
  console.log('idddd', institutionOwnerId);
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      institutionOwnerId:
        currAppointDetails?.data?.institutionOwnerId || institutionOwnerId,
  ...
  const onSubmit = handleSubmit(async data => {
    ...
    const result = await dispatch(createInstitutionAppointment(updatedData));
    // console.log('NEW result======================>>>>>>>>>>>>', result);
    console.log(data);
    if (createInstitutionAppointment.fulfilled.match(result)) {
      showAlert('Appointment Booked Successfully', 'success');
      navigation.replace('InstitutionAppointmentList');
    } else {
