...
const CultivationToolItem = ({item, onDelete, navigation}) => {
  ...
  return (
    <TouchableOpacity
      onPress={() =>
        navigation.navigate('CultivationToolDetail', {
          cultivationEquipmentId: item.cultivationEquipmentId,
        })
      }>
      <View
        style={[
          styles.CultivationToolItem,
...
export default CultivationToolItem;
