...
const CombineHarvesterItem = ({item, onDelete, navigation}) => {
  ...
  return (
    <TouchableOpacity
      onPress={() =>
        navigation.navigate('CombineHarvesterToolDetail', {
          combineHarvesterId: item.combineHarvesterId,
        })
      }>
      <View
        style={[
          styles.CombineHarvesterItem,
        ...
        <Text
          ...
          Power: {item.enginePowerHP} hp | Condition: {item.condition}
        </Text>
...
export default CombineHarvesterItem;
