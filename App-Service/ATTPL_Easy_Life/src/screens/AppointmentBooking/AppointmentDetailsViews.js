...
export default function AppointmentDetailsViews({route}) {
      ...
      <View style={styles.INcard}>
        ...
        {appointment.appointmentStatus == 'open' && (
          <Text style={{color: '#ff6f00'}}>
            Your appointment send to Candidate
          </Text>
        )}
        {appointment.appointmentStatus == 'in-progres' && (
          <Text style={{color: '#ff6f00'}}>
            Your Appointment Approved By Candidate{' '}
          </Text>
        )}
