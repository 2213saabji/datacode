...
// -----------------------------------------------------------
// Api call for Vendor Request List
// -----------------------------------------------------------

export function useGetVendorRequestList(authToken) {
  const URL = `${endpoints.requestLicenseAcceptance.Vendorlist}`;
  const headers = {
    'Content-Type': 'application/json',
    Authorization: `Bearer ${authToken}`,
  };
...
// -----------------------------------------------------------
// Api call for Ca Request List
// -----------------------------------------------------------

export function useGetCaRequestList(authToken) {
  const URL = `${endpoints.requestLicenseAcceptance.Calist}`;
  const headers = {
    'Content-Type': 'application/json',
    Authorization: `Bearer ${authToken}`,
  };
...
// -----------------------------------------------------------
// Api call for Single Lawyer Details
// -----------------------------------------------------------

export function useGetSingleLawyerDetails(id, authToken) {
  const URL = `${endpoints.requestLicenseAcceptance.LawyerDetails}/${id}`;
...
// -----------------------------------------------------------
// Api call for Single Vendor Details
// -----------------------------------------------------------

export function useGetSingleVendorDetails(id, authToken) {
  const URL = `${endpoints.requestLicenseAcceptance.VendorDetails}/${id}`;
...
// -----------------------------------------------------------
// Api call for Single CA Details
// -----------------------------------------------------------

export function useGetSingleCaDetails(id, authToken) {
  const URL = `${endpoints.requestLicenseAcceptance.CaDetails}/${id}`;
