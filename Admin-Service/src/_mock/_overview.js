...
// }));
export const _appFeatured = [...Array(35)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.postTitle(index),
  description: _mock.sentence(index),
  coverUrl: Cover_Img[index], // Use your locally defined image array
}));
...
export const _surveyNew = [...Array(5)].map((_, index) => ({
  guests: '12',
  id: _mock.id(index),
  bookedAt: _mock.time(index),
  duration: 'Expire in 3 days ',
  // isHot: _mock.boolean(index),
  name: _mock.fullName(index),
  // price: _mock.number.price(index),
  avatarUrl: _mock.image.avatar(index),
...
export const _pastSurvey = [...Array(5)].map((_, index) => ({
  guests: '12',
  id: _mock.id(index),
  bookedAt: _mock.time(index),
  duration: 'Expired',
