...
import { useGetTrip } from 'src/api/ambulance'; // Changed to useGetTrip

import { useSettingsContext } from 'src/components/settings';
import CustomBreadcrumbs from 'src/components/custom-breadcrumbs';

import AmbulanceTripNewEditForm from '../ambulance-trip-new-edit-form'; // Changed to TripNewEditForm

// ----------------------------------------------------------------------

export default function AmbulanceTripEditView({ id }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <AmbulanceTripNewEditForm currentTrip={currentTrip} />
    </Container>
  );
}

AmbulanceTripEditView.propTypes = {
  id: PropTypes.string,
};
