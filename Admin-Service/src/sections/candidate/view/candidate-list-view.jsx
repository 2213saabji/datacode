...
import { RenderCellStock, RenderCellProduct, RenderCellCreatedAt } from '../candidate-table-row';
...
export default function CandidateListView() {
  ...
  const { candidates, candidatesLoading } = useGetCandidates(user.accessToken);

  const candidateListArr = useMemo(
    () =>
  ...
  const handleDeleteRows = useCallback(async () => {
    try {
      ...
      console.error('API Error:', error);
      enqueueSnackbar(error.message || 'Failed to delete row', { variant: 'error' });
    }
