...
import VendorRequestListView from '../vendor-request-list-table';
import CharteredAccountRequestListView from '../ca-request-list-table';
...
export default function RequestListView() {
  ...
  return (
    <>
      ...
      {currentTab === 'vendor' && <VendorRequestListView currentTab={currentTab}/>}
      {currentTab === 'charteredAccountant' && <CharteredAccountRequestListView currentTab={currentTab}/>}
