...
export function RenderCellBarMembershipStatus({ params }) {
  const status = params?.row?.barMembershipStatus;
  let linkColor;
  if (status === 'Active') {
    linkColor = 'green';
    ...
    <ListItemText
      ...
      primary={
        <Link
          ...
          sx={{ cursor: 'pointer' }}
        >
          <Typography>{status || 'No Status'}</Typography>
        </Link>
      }
      sx={{ display: 'flex', flexDirection: 'column' }}
    />
...
// ------------------------Vendor cells functions-----------------------

export function RenderCellVendorId({ params }) {
  return (
    <ListItemText
      disableTypography
      primary={
...
RenderCellVendorId.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};

export function RenderCellVendorName({ params }) {
  return (
    <ListItemText
      disableTypography
      primary={
...
RenderCellVendorName.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};

export function RenderCellVendorCertificate({ params }) {
  return (
    <ListItemText
      disableTypography
      primary={
        <Link
          ...
          sx={{ cursor: 'pointer' }}
        >
          {params?.row?.licenseCertification}
        </Link>
      }
      sx={{ display: 'flex', flexDirection: 'column' }}
    />
...
RenderCellVendorCertificate.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};
...
export function RenderCellCaId({ params }) {
  return (
    <ListItemText
      disableTypography
      primary={
...
RenderCellCaId.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};

export function RenderCellCaName({ params }) {
  return (
    <ListItemText
      disableTypography
      primary={
...
RenderCellCaName.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};

export function RenderCellCaCertificate({ params }) {
  return (
    <ListItemText
      disableTypography
      primary={
...
RenderCellCaCertificate.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};
...
export function RenderCellVerificationButton({
  ...
  handleVerifyVendorDetails,
  handleVerifyCaDetails,
  ...
  const verifyRequestCaller = () => {
    if (currentTab === 'doctor') {
      ...
      handleVerifyVendorDetails(params.row.licenseCertification);
    } else if (currentTab === 'ca') {
      handleVerifyCaDetails(params.row.caCertificate);
    }
  };
  return (
    <ListItemText
...
RenderCellVerificationButton.propTypes = {
  ...
  handleVerifyVendorDetails: PropTypes.func,
  handleVerifyCaDetails: PropTypes.func,
...
export function RenderCellAcceptRequestButton({
  ...
  handleAcceptVendorDetails,
  handleAcceptCaDetails,
  handleRejectLawyerRequest,
  handleRejectVendorRequest,
  handleRejectCaRequest,
}) {
  ...
  function RejectRequestFunction(row) {
    if (currentTab === 'doctor') {
      ...
      handleRejectVendorRequest(row?.lmsVendorId);
      handleCloseRejectPopup();
    } else if (currentTab === 'ca') {
      handleRejectCaRequest(row?.caCertificate);
      handleCloseRejectPopup();
    }
  }
  return (
...
RenderCellAcceptRequestButton.propTypes = {
  ...
  handleAcceptCaDetails: PropTypes.func,
  handleRejectLawyerRequest: PropTypes.func,
  handleRejectVendorRequest: PropTypes.func,
  handleRejectCaRequest: PropTypes.func,
};
