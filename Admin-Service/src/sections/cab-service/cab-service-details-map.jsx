...
const CabServiceRoute = ({ driverLocation, userLocation }) => {
  ...
  const ambulanceIcon = useMemo(
    () => ({
      url: '/assets/images/cabService/mini_prime.png', // Path to your ambulance image
...
export default CabServiceRoute;
