...
export const endpoints = {
  our_work: {
    list: '/mock-data/our-work/fetchAll/mock',
    listModal: '/mock-data/our-work/fetchAll/modal',
    details: '/mock-data/our-work/fetch',
    update: '/mock-data/our-work/update',
    create: '/mock-data/our-work/create',
    status: '/mock-data/our-work/modal/activate',
  },
};
