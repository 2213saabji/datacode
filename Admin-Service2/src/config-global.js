...
const environments = {
  PROD: {
    ...
    ATTPL_TMS_SOCKET_API: import.meta.env.VITE_PROD_ATTPL_TMS_SOCKET_API,
    ...
    ATTPL_CHAT_SOCKET_URL: import.meta.env.VITE_PROD_ATTPL_CHAT_SOCKET_URL,
    ATTPL_LS_HOST_API: import.meta.env.VITE_PROD_ATTPL_LANDING_HOST_API,
    ATTPL_LMS_HOST_API: import.meta.env.VITE_PROD_ATTPL_LMS_HOST_API,
    ATTPL_INSTITUTE_AGRI_API: import.meta.env.VITE_PROD_ATTPL_INSTITUTE_AGRI_API,
  },
  DEV: {
    ...
    ATTPL_TMS_SOCKET_API: import.meta.env.VITE_DEV_ATTPL_TMS_SOCKET_API,
    ...
    ATTPL_CHAT_SOCKET_URL: import.meta.env.VITE_DEV_ATTPL_CHAT_SOCKET_URL,
    ATTPL_LMS_HOST_API: import.meta.env.VITE_DEV_ATTPL_LMS_HOST_API,
    ATTPL_INSTITUTE_AGRI_API: import.meta.env.VITE_DEV_ATTPL_INSTITUTE_AGRI_API,
  },
  TEST: {
    ...
    ATTPL_LMS_HOST_API: import.meta.env.VITE_TEST_ATTPL_LMS_HOST_API,
  },
  LOCAL: {
    ...
    ATTPL_BMS_HOST_API: import.meta.env.VITE_LOCAL_ATTPL_BMS_HOST_API,
    ...
    ATTPL_LMS_HOST_API: import.meta.env.VITE_LOCAL_ATTPL_LMS_HOST_API,
  },
};
...
const {
  ...
  ATTPL_TMS_HOST_API,
  ATTPL_TMS_SOCKET_API,
  ATTPL_AMS_HOST_API,
  ATTPL_CHAT_HOST_API,
  ATTPL_CHAT_SOCKET_URL,
  ATTPL_SMS_HOST_API,
  ATTPL_LS_HOST_API,
  ATTPL_LMS_HOST_API,
  ATTPL_INSTITUTE_AGRI_API,
  ASSETS_API,
  MAPBOX_API,
...
const { ATTPL_AWS_ACCESS_KEY_ID, ATTPL_AWS_SECRET_ACCESS_KEY, ATTPL_AWS_REGION, ATTPL_AWS_BUCKET } =
  aws;
...
// google AMp API Key
const google = {
  ATTPL_GOOGLE_MAP_KEY: import.meta.env.VITE_ATTPL_GOOGLE_MAP_API_KEY,
};

const { ATTPL_GOOGLE_MAP_KEY } = google;
