...
// import AmbulanceAnalytic from '../ambulance-analytics';
...
export default function AmbulanceManagedListView() {
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.dashboard.callAmbulance.tripManagement(id)); // Changed to trip
    },
    [router]
  );
