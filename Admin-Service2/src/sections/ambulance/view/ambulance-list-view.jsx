...
import WardvolTableFiltersResult from '../ambulance-table-filters-result';
import {
  RenderCell,
  RenderCellStock,
  RenderCellPrice,
  RenderCellTripId,
  RenderCellCreatedAt,
} from '../ambulance-table-row'; // Changed to trip-table-row
// import WardVolAnalytics from '../ambulance-analytics';
...
export default function AmbulancelistListView() {
          ...
          links={[
            {
              ...
              href: paths.dashboard.callAmbulance.requestedtrip, // Changed to paths.dashboard.trip.root
            },
            { name: 'List' },
          ]}
          action={
