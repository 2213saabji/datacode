...
function TuorAndTravelsCard({ cards }) {
...
const handlePrimaryButtonClick = () => {
    if (selectedCard?.applyUrl) {
      window.open(selectedCard.applyUrl, '_blank'); // Open applyUrl in a new tab
    }
    setDialogOpen(false);
  };
...
export default TuorAndTravelsCard;
