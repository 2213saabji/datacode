...
export default function BrowseView() {
  ...
  const ServiceData = ServiceListArr.filter((list) => list.userRoleId === 49).map((list) => ({
  // .map((list) => ({
  ...
  const handleViewNext = useCallback(
    () => {
      router.push(paths.dashboard.chartered_accountant.filter);
    },
    [router]
  );
  ...
  return (
    ...
    {/* <Box sx={gridStyle}>
      <img
        src="/assets/images/Description of Image/Chartered Accountant View.png"
     ...
     <Button
      ...
      <CustomBreadcrumbs
        ...
        links={[
          {
            name: 'FOR WHICH YOU ARE LOOKLING A CHARTED ACCOUNTANT!',
          },
        ]}
        sx={{
          mb: { xs: 3, md: 5 },
