...
export function ChartedAccountantItemSkeleton({ sx, ...other }) {
  return (
    <Paper
      variant="outlined"
      sx={{
...
ChartedAccountantItemSkeleton.propTypes = {
  sx: PropTypes.object,
};

// ----------------------------------------------------------------------

export default function ChartedAccountantDetailsSkeleton({ ...other }) {
  return (
