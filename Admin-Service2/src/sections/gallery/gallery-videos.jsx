...
export default function GalleryVideos({ galleryDataVideos, deleter }) {
  const cardsData = [
    {
      id: 1,
...
`;
  ...
  return (
    <Box>
      ...
      {galleryDataVideos.length === 0 && (
        <EmptyContent title="No Media" description="There is no data available." sx={{ py: 0 }} />
      )}
...
GalleryVideos.propTypes = {
  galleryDataVideos: PropTypes.object,
