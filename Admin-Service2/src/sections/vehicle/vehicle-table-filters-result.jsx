...
export default function VehicleTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
  ...
  const handleRemovePublish = useCallback(
    (inputValue) => {
      const newValue = filters.vehicleType.filter((item) => item !== inputValue);

      onFilters('vehicleType', newValue);
    },
    [filters.vehicleType, onFilters]
  );
  console.log(filters);
...
VehicleTableFiltersResult.propTypes = {
