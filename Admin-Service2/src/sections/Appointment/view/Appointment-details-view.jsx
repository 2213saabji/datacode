        ...
        <Grid item xs={12} md={7} sx={{ display: 'flex', flexWrap: 'wrap' }}>
          ...
          >
            <CardContent sx={{ margin: 'auto', color: 'black' }}>
              {appointment?.data?.appointmentStatus === 'in-progres' ? (
                <Typography
                  variant="h5"
                  color="#fff"
            ...
            {(appointment?.data?.appointmentType === 'office' ||
                ...
                {voter && appointment?.data?.appointmentType === 'office' && (
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, margin: 'auto' }}>
                    ...
                    <Typography>
                      ...
                      {appointment?.data?.reportingContactAddress}
                    </Typography>
                    <Typography>
                      <span style={{ fontWeight: 'bold' }}>Contact Person Name:</span>{' '}
                      {appointment?.data?.reportingContactName}
                    </Typography>
                    <Typography>
                      <span style={{ fontWeight: 'bold' }}>Contact Mobile No.:</span>{' '}
                      {appointment?.data?.reportingContactNumber}
                    </Typography>
                    <Typography>
