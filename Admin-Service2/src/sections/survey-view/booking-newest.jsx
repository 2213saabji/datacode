    ...
    >
      ...
      >
        ...
        <Stack direction="row" alignItems="center">
          ...
          {/* <Typography sx={{color: 'text.secondary', typography: 'caption', fontWeight:700 }}>Expires in:</Typography> &nbsp; */}
          {/* <Iconify icon="svg-spinners:clock"/> */}
      ...
      <div style={{ textAlign: 'center' }}>
        <Button variant="outlined" onClick={() => funClick(surveyId)} sx={{ width: '200px', m: 1 }}>
          Open
        </Button>
      </div>
    </Paper>
