...
//   //       router.push(`/dashboard/lawyer/${providerId}`);
//   //     } else {
...
//   const handleBookLawyer = async (id, userId, providerId) => {
//     try {
//       // Adjust URL and parameters as needed
//       const response = await createNotifications(/* parameters for lawyer booking */);
//       if (response?.success) {
//         enqueueSnackbar('Booking successful!', { variant: 'success' });
//         router.push(`/dashboard/lawyer/${providerId}`);
//       } else {
...
//     try {
//       const response = await deleter(`/lawyer/delete/${id}`, { method: 'DELETE' });
//       if (response.success) {
//         enqueueSnackbar('Delete success!', { variant: 'success' });
...
//   const value = inputData.filter((item) => item?.serviceId.toString() === serviceId || item?.issueId.toString() === issueId);
